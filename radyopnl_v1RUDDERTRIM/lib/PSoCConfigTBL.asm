...
;       Instance name Counter8_1, Block Name CNTR8(DCB03)
	...
	mov	reg[2dh], 64h		;Counter8_1_PERIOD_REG(DCB03DR1)
	mov	reg[2eh], 1fh		;Counter8_1_COMPARE_REG(DCB03DR2)
...
;  Global Register values
	...
	mov	reg[e1h], feh		; OscillatorControl_1 register (OSC_CR1)
...
;       Instance name Counter8_1, Block Name CNTR8(DCB03)
	...
	mov	reg[2dh], 17h		;Counter8_1_INPUT_REG(DCB03IN)
